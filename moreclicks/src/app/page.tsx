  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <header className="relative border-b-2 border-blue-300/50 dark:border-blue-800/50 bg-blue-600 dark:bg-gray-900 sticky top-0 z-50 shadow-xl overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto flex h-16 items-center justify-between px-6">
          <Link href="/" className="flex items-center gap-2 hover:scale-105 transition-all duration-300 group slide-in-top">
            <div className="relative w-10 h-10 flex-shrink-0 translate-x-1 translate-y-1">
              <Image 
            ...
            <span className="text-2xl font-black tracking-tight">
              ...
              <span className="text-white dark:text-gray-100">.io</span>
            </span>
          </Link>
          <div className="flex items-center gap-4">
            <ThemeToggle />
            <Link href="/pricing">
              <Button variant="ghost" className="text-white dark:text-gray-200 hover:text-purple-200 dark:hover:text-purple-300 hover:bg-white/20 dark:hover:bg-white/10 font-semibold transition-all duration-200 hover:scale-105">Pricing</Button>
            </Link>
            <Link href="/sign-in">
              <Button variant="ghost" className="text-white dark:text-gray-200 hover:text-purple-200 dark:hover:text-purple-300 hover:bg-white/20 dark:hover:bg-white/10 font-semibold transition-all duration-200 hover:scale-105">Sign In</Button>
            </Link>
            <Link href="/sign-up">
              <Button className="bg-blue-200 dark:bg-blue-700 text-blue-700 dark:text-blue-100 hover:bg-blue-100 dark:hover:bg-blue-600 font-bold shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl">Get Started</Button>
            </Link>
          </div>
        </div>
      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="container mx-auto px-6 max-w-4xl relative z-10">
            <h1 className="text-6xl md:text-7xl font-extrabold mb-6 leading-tight">
              ...
              <span className="bg-blue-600 text-white px-6 py-3 inline-block fade-in-up my-2" style={{ animationDelay: '0.2s' }}>SEO Analysis</span>
              <span className="gradient-text-3 block text-5xl md:text-6xl mt-3 fade-in-up" style={{ animationDelay: '0.3s' }}>That Actually Works</span>
            </h1>
            <p className="text-xl font-semibold text-purple-600 dark:text-purple-400 mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex gap-4 justify-center flex-wrap fade-in-up" style={{ animationDelay: '0.5s' }}>
              <Link href="/sign-up" className="group">
                <Button size="lg" className="text-lg px-8 transition-all duration-200 hover:scale-105 hover:shadow-xl">
                  Start Free Trial
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
              <Link href="/pricing">
                <Button size="lg" variant="outline" className="text-lg px-8 transition-all duration-200 hover:scale-105 hover:shadow-lg">
                  View Pricing
                </Button>
              </Link>
            </div>
        ...
        {/* Features Section */}
        <section className="bg-muted/50 dark:bg-gray-900/50 py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl font-bold text-purple-600 dark:text-purple-400 max-w-2xl mx-auto tracking-wide">
        ...
        <section className="bg-muted/50 py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl font-bold text-purple-600 dark:text-purple-400 tracking-wide">
        ...
        >
          <div className="absolute inset-0 bg-black/10"></div>
          <div className="container mx-auto px-6">
            <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-2xl p-12 text-center max-w-4xl mx-auto shadow-2xl relative z-10">
            ...
            <p className="text-xl mb-8 font-semibold text-purple-100">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <Link href="/pricing">
                <Button size="lg" variant="outline" className="text-lg px-8 bg-transparent border-white/20 text-white hover:bg-white/10">
                  View All Plans
                </Button>
              </Link>
            </div>
